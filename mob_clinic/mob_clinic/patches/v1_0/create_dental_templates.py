...
def create_condition_templates():
	...
	conditions = [
		...
		{"code": "COND-007", "type": "extraction", "label": "Extraction Recommended", "category": "Surgical", "severity": None, "description": "Tooth requires removal", "icon": "❌", "color": "#B91C1C", "treatment": True},
